...
Дев-роутеры для разработки пакетов OpenWrt и ImmortalWrt. Один файл, одна
команда, работающие роутеры — на Linux, WSL2, Docker Desktop для Windows или
macOS.
...
Дальше [docs/troubleshooting.ru.md](docs/troubleshooting.ru.md). Почти всё, что
...
В [docs/runbook.ru.md](docs/runbook.ru.md) — процедуры: задача, команды и как
убедиться, что вышло.
